...
class CharacterChatBot():
    ...
    def __init__(self,
                 model_path,
                 data_path="/content/data/naruto-transcript-ep1.csv",
    ...
    def load_data(self):
        ...
        naruto_transcript_df.loc[(naruto_transcript_df['name']=="Naruto")&(naruto_transcript_df['number_of_words']>0),'naruto_response_flag']=1
